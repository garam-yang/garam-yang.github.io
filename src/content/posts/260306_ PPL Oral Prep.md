...
https://courses.sportys.com/training/portal/demo/course/PRIVATE/testprep/faa-test-report
...
PA.II.A.K3 – Airplane Preflight Inspection 
...
→ 타이어 트레드는 홈(tread)이 명확히 보여야 하며 내부 코드(cord)가 드러나면 안 된다. 
트레드가 심하게 닳거나 코드가 보이면 그 타이어는 감항성이 없으며 교체해야 한다.
...
→ 타이어 압력이 낮으면 정비사가 규정 압력으로 공기를 보충해야 한다. 
타이어가 손상되었거나 공기가 새면 수리하거나 교체해야 한다.
...
**Q. What do you check about the engine during preflight inspection?**


→ 프리플라이트 시 엔진에서 무엇을 확인합니까?


**A.**


During preflight inspection, I check:


- Engine oil level 
- Any leaks in the engine compartment 
- Visible issues with components such as spark plugs or cylinders 


This ensures the engine is in safe operating condition before flight.


→ 프리플라이트 시 다음 항목을 확인한다.


- 엔진 오일량
- 엔진 구획 누유 여부
- 스파크 플러그나 실린더 등의 이상 여부


이를 통해 엔진이 정상적으로 작동할 수 있는 상태인지 확인한다.


### Engine Oil Quantity


**Q. What is the minimum oil quantity required for a Piper aircraft used for training?** 
→ 훈련용 Piper 항공기의 최소 오일량은 얼마인가요?


**A.** 
For many Piper training aircraft, the minimum recommended oil quantity is about **2 quarts**, although it is usually kept higher during normal operations.


→ 많은 Piper 훈련용 항공기에서는 최소 약 **2쿼트의 오일**이 필요하다. 
하지만 실제 운용에서는 보통 그보다 **더 높은 수준으로 유지**한다.
...
PA.II.B.K1 – Passenger briefing requirements, including the operation and required use of safety restraint systems. 
Area of Operation II – Preflight Procedures 
...
**Q. When are passengers required to wear seatbelts and shoulder harnesses?** 
→ 승객은 언제 안전벨트와 숄더 하네스를 착용해야 합니까?


**A.** 
According to **14 CFR 91.107**, each person on board must have their **seatbelt fastened during taxi, takeoff, and landing.**


If a **shoulder harness is installed**, it must also be worn during those phases of flight.


→ **14 CFR 91.107**에 따르면 모든 탑승자는 **지상이동, 이륙, 착륙 중** 안전벨트를 착용해야 한다. 
또한 **숄더 하네스가 설치되어 있다면 함께 착용해야 한다.**
...
**Q. What must the pilot do regarding seatbelts before takeoff?** 
→ 이륙 전에 조종사는 안전벨트와 관련하여 무엇을 해야 합니까?


**A.** 
The pilot in command must **brief passengers on how to fasten and unfasten their seatbelts and shoulder harnesses before takeoff.**


→ 기장은 이륙 전에 **안전벨트와 숄더 하네스를 착용하고 푸는 방법을 승객에게 설명해야 한다.**
...
**Q. Why must you brief passengers on how to open the door?** 
→ 왜 승객에게 문 여는 방법을 설명해야 합니까?


**A.** 
Passengers must know how to open the door in case of an **emergency landing or accident**, so they can quickly evacuate the aircraft if the pilot becomes incapacitated.


→ 비상 착륙이나 사고 발생 시 조종사가 대응하지 못할 수도 있기 때문에 
승객이 **신속하게 탈출할 수 있도록 문 여는 방법을 설명해야 한다.**
...
**Q. Who might need to open the aircraft door during an emergency?** 
→ 비상 상황에서 누가 문을 열어야 할 수 있습니까?


**A.** 
In an emergency situation, **a passenger may need to open the door if the pilot is unable to do so.**


→ 비상 상황에서는 **조종사가 대응하지 못할 경우 승객이 문을 열어야 할 수도 있다.**
...
**Q. What is the purpose of the ELT?** 
→ ELT의 목적은 무엇입니까?


**A.** 
The **Emergency Locator Transmitter (ELT)** sends a distress signal after a crash to help search and rescue teams locate the aircraft.


→ ELT는 항공기가 사고를 당했을 때 **조난 신호를 보내 구조팀이 항공기를 찾을 수 있도록 하는 장치**이다.
...
**Q. What is the normal position of the ELT switch during flight?** 
→ 비행 중 ELT 스위치의 정상 위치는 무엇입니까?


**A.** 
The normal position is **ARM**, which allows the ELT to **activate automatically during an impact.**


→ 정상 위치는 **ARM**이며, 충돌 시 **자동으로 작동하도록 설정된 상태**이다.
...
### Manual ELT Activation


**Q. Can the ELT be activated manually?** 
→ ELT는 수동으로 작동시킬 수 있습니까?


**A.** 
Yes. The ELT can be **manually activated using the ELT switch in the cockpit if necessary.**


→ 네. 필요 시 **조종석에 있는 ELT 스위치를 통해 수동으로 작동시킬 수 있다.**
...
**Q. Where is the fire extinguisher located in the aircraft?** 
→ 소화기는 항공기 어디에 있습니까?
...
The fire extinguisher is typically located within reach of the pilot or passengers. 
Depending on the aircraft model, it is usually mounted near the **floor area or behind the seats**.


→ 소화기는 보통 조종사나 승객이 **손이 닿는 위치**에 있으며, 
기종에 따라 **좌석 뒤쪽이나 바닥 근처**에 설치되어 있다.
...
**Q. Who can use the fire extinguisher during an emergency?** 
→ 비상 상황에서 누가 소화기를 사용할 수 있습니까?


**A.**


Either the **pilot or a passenger** may use the fire extinguisher if necessary.


→ 필요할 경우 **조종사나 승객 모두** 사용할 수 있다.
...
### How to Aim a Fire Extinguisher


**Q. How should you aim a fire extinguisher when putting out a fire?** 
→ 불을 끌 때 소화기는 어디를 겨냥해야 합니까?


**A.**


The extinguisher should be aimed at **the base of the flame**, not the top of the fire.


→ 소화기는 **불꽃의 윗부분이 아니라 불의 밑부분 (base of the flame)** 을 향해 사용해야 한다.
...
During taxi operations, the pilot must be able to interpret **airport signage and markings**, such as **direction signs and runway indications.**


For example, a **direction sign array** may indicate:


- The direction to a specific **runway**
- The direction to a specific **taxiway (e.g., Taxiway A)**


→ 택싱 중에는 공항 표지판과 마킹을 읽을 수 있어야 한다. 
예를 들어 **Direction Sign Array**를 통해 어느 방향이 특정 활주로인지, 어느 방향이 **Taxiway A**인지 확인할 수 있다.
...
PA.IV.A.R2d – The applicant is able to identify, assess, and mitigate risk associated with wake turbulence effects.


Area of Operation IV – Takeoffs, Landings, and Go-Arounds 
Task A – Takeoff and Climb
...
→ 윈드시어는 짧은 거리에서 바람의 **속도나 방향이 급격하게 변하는 현상**이다. 
특히 **이륙이나 착륙 중** 항공기의 속도, 고도, 비행 경로에 큰 변화를 일으킬 수 있다.
...
**Q. Which flight instruments may indicate wind shear?** 
→ 어떤 비행 계기가 윈드시어를 나타낼 수 있는가?


| Instrument | Indication |
|---|---|
| Airspeed Indicator | Sudden gain or loss of airspeed |
| Vertical Speed Indicator | Unexpected climb or descent |
| Attitude Indicator | Uncommanded pitch changes |
...
| 계기 | 나타나는 현상 |
|---|---|
| Airspeed Indicator | 속도의 갑작스러운 증가 또는 감소 |
| VSI | 예상치 못한 상승 또는 하강 |
| Attitude Indicator | 의도하지 않은 피치 변화 |
...
**Q. What would you do if you encounter strong wind or wind shear on final approach?** 
→ 최종 접근 중 강한 바람이나 윈드시어를 만나면 어떻게 해야 하는가?


**A.**


If the wind conditions become unsafe during final approach, the safest action is to **execute a go-around** and attempt another approach when conditions improve.


→ 최종 접근 중 바람 상태가 위험하다고 판단되면 **고어라운드를 실시하고 상황이 좋아질 때 다시 접근하는 것이 가장 안전하다.**
...
→ 웨이크 터뷸런스는 항공기가 양력을 생성할 때 날개 끝에서 발생하는 **와류(wingtip vortices)** 로 인해 발생하는 난기류이다. 
특히 **대형 또는 무거운 항공기 뒤에서 강하게 발생한다.**
...
→ 앞선 항공기의 이륙 지점이나 터치다운 지점을 정확히 알 수 없다면 
**약 3분 정도 기다리는 것이 안전하다.**
...
→ Go-around는 **착륙 접근을 중단하고 다시 상승하여 재접근을 시도하는 절차**이다.
...
→ 가장 흔한 이유 중 하나는 **돌풍이나 불안정한 공기 상태로 인해 접근이 안정적이지 않은 경우**이다.
...
→ Ground effect는 항공기가 지면 가까이 비행할 때 **유도 항력이 감소하고 양력이 증가하는 현상**이다.
...
→ Ground effect는 지면에서 약 **한 날개 길이(wingspan) 이내**에서 가장 뚜렷하며 
특히 **이륙과 착륙 시** 나타난다.
...
### Q. What does the magnetic compass point to? 
→ 자기 나침반은 무엇을 가리키나요?
...
→ 자기 나침반은 **진북(True North)이 아니라 자기북(Magnetic North)**을 가리킨다.
...
True north refers to the **geographic North Pole**, while magnetic north refers to the **Earth’s magnetic pole**, which is where the compass actually points.


→ 진북은 **지리적 북극(지구 자전축 기준)**을 의미하고 
자기북은 **지구 자기장의 북극**, 즉 나침반이 실제로 가리키는 방향이다.
...
The common mnemonic for magnetic compass errors is **DVMONA**.


| Letter | Error | Description |
|------|------|-------------|
| D | Deviation | Error caused by magnetic fields from the aircraft’s electrical systems and metal components |
| V | Variation | Difference between true north and magnetic north caused by the Earth's magnetic field |
| M | Magnetic Dip | Compass needle is pulled downward toward the magnetic poles |
| O | Oscillation | Compass card swings or vibrates during turbulence or maneuvering |
| N | Northerly Turning Error | Error occurring in the Northern Hemisphere when turning to or from a northerly heading |
| A | Acceleration Error | Error occurring during acceleration or deceleration, especially on east or west headings |
...
| 약어 | 오차 | 설명 |
|-----|-----|-----|
| D | Deviation | 항공기 내부 전자 장비나 금속 구조에서 발생하는 자기장의 영향으로 생기는 오차 |
| V | Variation | 진북(True North)과 자북(Magnetic North)의 차이 |
| M | Magnetic Dip | 지구 자기장이 나침반 바늘을 자기극 방향으로 아래로 끌어당기는 현상 |
| O | Oscillation | 난기류나 기동 중 나침반 카드가 흔들리는 현상 |
| N | Northerly Turning Error | 북반구에서 북쪽 방향으로 선회할 때 발생하는 오차 |
| A | Acceleration Error | 가속 또는 감속 시, 특히 동서 방향에서 발생하는 오차 |
...
### Q. What are the dangers associated with unusual attitudes? 
→ 비정상 자세(unusual attitude)에서 발생할 수 있는 위험은 무엇인가?
...
- Possible entry into a **spiral dive or stall**


→ 비정상 자세의 주요 위험은 다음과 같다.


- 항공기 조종 상실 
- 과도한 속도 증가 
- 기체 구조에 대한 과부하 
- 스파이럴 다이브 또는 실속 상태로 진입
...
PA.IX.B.K2a – Airspeed, including importance of best glide speed and its relationship to distance 
...
→ Best glide speed는 **엔진이 정지했을 때 주어진 고도에서 가장 먼 수평 거리를 비행할 수 있는 속도**이다.
...
야간 VFR 비행은 **주간 VFR 장비 + 야간 장비**가 필요하며 
이는 **FAR 91.205**에 규정되어 있다.
...
Night equipment는 **FLAPS**로 외운다.


| Letter | Meaning | 한국어 |
|------|------|------|
| F | Fuses (spare) | 예비 퓨즈 |
| L | Landing light (for hire) | 착륙등 |
| A | Anti-collision light | 충돌 방지등 |
| P | Position lights | 위치등 |
| S | Source of electrical power | 전기 전원 |


---


# Landing Light Requirement
...
### Q. What do you need before you can legally fly as a private pilot? 
→ 개인 조종사로서 합법적으로 비행하기 위해 무엇이 필요한가?


**A.**


To act as a **Pilot in Command (PIC)**, a pilot must have:
...
기장(PIC)으로 비행하려면 다음이 필요하다.


- 유효한 조종사 자격증 (Pilot Certificate) 
- 유효한 메디컬 증명서 (Medical Certificate) 
- 정부 발급 신분증 
...
최근 **90일 이내 동일 Category/Class 항공기에서 
3번의 이륙과 착륙을 완료해야 한다.**
...
Flight Review는 **14 CFR 61.56**에 따라 
**24개월마다** 필요하다.
...
Flight Review는 **24번째 달의 말일까지 유효**하므로 
**2026년 2월 말까지 유효하다.**
...
| Term | Meaning |
|-----|------|
| Currency | Meeting the **legal requirements** to act as PIC |
| Proficiency | The pilot’s **actual skill and ability** to safely operate the aircraft |
...
| 용어 | 의미 |
|-----|-----|
| Currency | 법적으로 비행이 가능한 상태 |
| Proficiency | 실제 비행 능력과 숙련도 |
...
→ 날개는 에어포일 위의 **매끄러운 공기 흐름**을 통해 양력을 생성한다. 
하지만 서리는 이 흐름을 방해하여 **양력을 감소시키고 효율을 떨어뜨린다.**
...
→ 최신 기상 브리핑을 위해 
**Flight Service Station(FSS)**에 전화할 수 있으며 번호는
...
FAA에서는 **뇌우로부터 최소 20NM 이상 떨어질 것**을 권장한다.
...
# Icing Conditions – Preflight Decision
...
→ 대부분의 훈련용 항공기는 
**Known Icing Conditions에서 비행이 허가되지 않는다.**
...
| Type | Meaning |
|-----|-----|
| De-icing | 이미 형성된 얼음을 제거 |
| Anti-icing | 얼음이 형성되는 것을 방지 |
...
# Instrument Affected by Pitot Ice
...
→ **대기 속도계(Airspeed Indicator)**가 영향을 받는다. 
속도계는 **피토 압력(pitot pressure)**을 이용해 속도를 측정하기 때문이다.


---


# Pitot Tube Failure Scenario
...
→ 카뷰레터 히트는 **배기 시스템에서 나오는 뜨거운 공기**를 사용하여 
카뷰레터 내부에 형성된 얼음을 녹인다.
...
→ 카뷰레터 히트를 사용하면 **RPM이 약간 감소한다.** 
이는 따뜻한 공기가 차가운 공기보다 **밀도가 낮기 때문이다.**
...
→ 일산화탄소는 엔진 배기에서 발생하는 **무색, 무취의 가스**이며 
혈액의 **산소 운반 능력을 감소시켜 중독을 일으킬 수 있다.**
...
→ Class B 공역 진입 허가는 **ATC**, 즉 해당 공역을 담당하는 **Approach Control**이 부여한다.
...
→ 적절한 주파수로 **Approach Control**에 연락하여 
Bravo 공역 진입 허가를 요청할 수 있다.


---


# Equipment Requirements for Class B
...
→ 주요 위험은 **대형 항공기의 Wake Turbulence**이다.
...
→ 주요 위험은 **Wake Turbulence**이며 
이는 작은 항공기에 **갑작스러운 롤링과 조종 상실**을 일으킬 수 있다.
...
→ Class C 공역에 진입하기 전에 
**ATC와 양방향 교신(two-way communication)**이 이루어져야 한다.
...
→ Restricted Area는 
**해당 공역을 통제하는 기관의 허가가 있을 때만 진입 가능하다.**
...
→ 점선 마젠타는 **Class E Transition Area 경계**를 의미한다.
...
엔진 시동 전에는 **배터리**가 전력을 공급한다.


엔진이 시동되면 **엔진 벨트로 구동되는 알터네이터**가 전기를 생산하며 
이때부터 **알터네이터가 주요 전력 공급원**이 된다.


알터네이터는 전력을 **primary bus**로 보내고, 이 버스가 다음 장비에 전력을 분배한다.
...
알터네이터는 약 **14V**를 생산하며 
이는 **12V 배터리보다 높기 때문에 전력 공급과 동시에 배터리를 충전한다.**
...
왜냐하면 점화 시스템이 **magneto**로 작동하며 
이는 **전기 시스템과 독립적**이기 때문이다.
...
엔진은 **magneto 시스템**을 사용한다.


Magneto는 **자체적으로 전기를 생성**하여 
스파크 플러그에 전력을 공급한다.
...
엔진 동력은 **실린더 내부에서 연료와 공기가 연소하면서 발생하는 힘**이며 
magneto가 스파크 플러그를 작동시켜 점화를 만든다.
...
엔진 한계치, 운용 절차, 성능 정보는 **POH**를 주요 참고 자료로 사용한다.
...
### Q. Please describe the fuel system.
연료 시스템을 설명해 보세요.
...
The aircraft fuel system stores fuel in two fuel tanks located in the wings.


Each tank holds approximately **25 gallons**, for a total capacity of about **50 gallons**, although about **1 gallon in each tank is unusable fuel**.


Fuel flows from the tanks through **fuel lines** to the **fuel selector valve**, which allows the pilot to select the fuel source.


After the selector valve, fuel passes through the **fuel strainer (fuel sump)** where water and contaminants are removed.


After the fuel strainer, the fuel flow splits into two paths.


One path goes to the **primer system**, which delivers fuel directly to the engine cylinders to assist with engine starting.


The other path continues through the **electric fuel pump** and the **engine-driven fuel pump**, which supply fuel pressure to the engine.


Finally, fuel enters the **carburetor**, where it mixes with air and is delivered to the engine cylinders for combustion.


### Q. How do you detect water contamination during preflight?
프리플라이트 중 물 오염을 어떻게 확인하는가?
...
Hypoxia is a condition in which the body or brain does not receive enough oxygen.


---

**Q. What are the symptoms of hypoxia?**  
→ 저산소증(hypoxia)의 증상은 무엇인가?
...
스핀은 **심화된 실속 상태에서 자동 회전이 발생하며 나선형으로 하강하는 상태**이다.
...
P – Power idle 
A – Ailerons neutral 
R – Rudder full opposite direction of the spin 
...
밤에는 시각이 **rod cell(간상세포)**에 더 의존하게 되며 빛에는 민감하지만 세부나 색상 인식 능력은 떨어진다. 
완전한 야간 시각 적응에는 약 **30분**이 필요하며 밝은 빛은 일시적으로 야간 시력을 감소시킬 수 있다.
...
밝은 빛을 피하고 **적색 조명 또는 빨간 손전등**을 사용한다.
...
항로 추적(course tracking)에는 **VOR 1개**면 충분하다.


위치 결정(position fix)에는 **VOR 2개**가 필요하며 두 개의 radial 교차로 위치를 찾는다.


DME가 있다면 **VOR 1개 + DME**로 위치를 결정할 수 있다.
